...
export default function Show({auth, project}) {
    ...
    useEffect(() => {
        setData(project.transactions.map(transaction => {
            return {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<HeaderTitle title="Project Details"/>}
        >
                    ...
                    <section>
                        ...
                        <div className="mt-4">
                            <div className="grid gap-y-5 sm:grid-cols-3">
                                ...
                                <InfoCard label="Document URL" value={
                                ...
                                <InfoCard label="Start Date" value={
                                    createDateAttribute(project.start_date)
                                }/>
                                <InfoCard label="End Date" value={
                                    createDateAttribute(project.end_date)
                                }/>
                                <InfoCard label="Costing" value={
                                    createCostingAttribute(project.costing)
                                }/>
                            </div>
                        </div>
                    </section>
