...
export default function Index({ auth, media, photos = [] }) {
    ...
    const tabActiveCss = "flex items-center flex-shrink-0 px-5 py-3 space-x-2 border border-b-0 rounded-t-lg border-gray-600 text-gray-900"

    const TabMenu = () => {
        return (<div
            className="flex items-center -mx-4 overflow-x-auto overflow-y-hidden sm:justify-start flex-nowrap text-gray-800">
            <Link rel="noopener noreferrer" href={route("media")}
            ...
            <Link rel="noopener noreferrer" href={route("media.unsplash")}
    ...
    >
        ...
        <Main>
            ...
            {route().current("media.unsplash") && <Unsplash
